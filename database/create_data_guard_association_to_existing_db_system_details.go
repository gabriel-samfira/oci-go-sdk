...
type CreateDataGuardAssociationToExistingDbSystemDetails struct {
	...
	ProtectionMode CreateDataGuardAssociationDetailsProtectionModeEnum `mandatory:"" json:"protectionMode"`
	...
	TransportType CreateDataGuardAssociationDetailsTransportTypeEnum `mandatory:"" json:"transportType"`
}
