...
const (
	...
	VolumeBackupSourceTypeUnknown   VolumeBackupSourceTypeEnum = "UNKNOWN"
)
...
var mappingVolumeBackupSourceType = map[string]VolumeBackupSourceTypeEnum{
	...
	"UNKNOWN":   VolumeBackupSourceTypeUnknown,
}
...
func GetVolumeBackupSourceTypeEnumValues() []VolumeBackupSourceTypeEnum {
	...
	for _, v := range mappingVolumeBackupSourceType {
		if v != VolumeBackupSourceTypeUnknown {
			values = append(values, v)
		}
	}
	return values
...
const (
	...
	VolumeBackupTypeUnknown     VolumeBackupTypeEnum = "UNKNOWN"
)
...
var mappingVolumeBackupType = map[string]VolumeBackupTypeEnum{
	...
	"UNKNOWN":     VolumeBackupTypeUnknown,
}
