...
const (
	...
	PublicIpLifecycleStateUnknown      PublicIpLifecycleStateEnum = "UNKNOWN"
)
...
var mappingPublicIpLifecycleState = map[string]PublicIpLifecycleStateEnum{
	...
	"UNKNOWN":      PublicIpLifecycleStateUnknown,
}
...
func GetPublicIpLifecycleStateEnumValues() []PublicIpLifecycleStateEnum {
	...
	for _, v := range mappingPublicIpLifecycleState {
		if v != PublicIpLifecycleStateUnknown {
...
const (
	...
	PublicIpLifetimeUnknown   PublicIpLifetimeEnum = "UNKNOWN"
)
...
var mappingPublicIpLifetime = map[string]PublicIpLifetimeEnum{
	...
	"UNKNOWN":   PublicIpLifetimeUnknown,
}
...
const (
	...
	PublicIpScopeUnknown            PublicIpScopeEnum = "UNKNOWN"
)
