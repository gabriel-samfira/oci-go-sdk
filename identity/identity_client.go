...
// about policies, see [How Policies Work]({{DOC_SERVER_URL}}/Content/Identity/Concepts/policies.htm).
...
// See [Retiring Key Definitions and Namespace Definitions]({{DOC_SERVER_URL}}/Content/Identity/Concepts/taggingoverview.htm#Retiring) for more information.
...
// [Retiring Key Definitions and Namespace Definitions]({{DOC_SERVER_URL}}/Content/Identity/Concepts/taggingoverview.htm#Retiring).
