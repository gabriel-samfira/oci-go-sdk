...
// For more information, see [Managing Dynamic Groups]({{DOC_SERVER_URL}}/Content/Identity/Tasks/managingdynamicgroups.htm).
type DynamicGroup struct {
	...
	// For syntax, see [Managing Dynamic Groups]({{DOC_SERVER_URL}}/Content/Identity/Tasks/managingdynamicgroups.htm).
...
const (
	...
	DynamicGroupLifecycleStateUnknown  DynamicGroupLifecycleStateEnum = "UNKNOWN"
)
...
var mappingDynamicGroupLifecycleState = map[string]DynamicGroupLifecycleStateEnum{
	...
	"UNKNOWN":  DynamicGroupLifecycleStateUnknown,
}
...
func GetDynamicGroupLifecycleStateEnumValues() []DynamicGroupLifecycleStateEnum {
	...
	for _, v := range mappingDynamicGroupLifecycleState {
		if v != DynamicGroupLifecycleStateUnknown {
